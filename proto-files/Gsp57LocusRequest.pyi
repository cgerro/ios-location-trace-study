...
class Gsp57LocusRequest(_message.Message):
    ...
    service_data: Gsp57LocusServiceData
    country_data: Gsp57LocusCountryData
    country_code: str
    subdata: _containers.RepeatedCompositeFieldContainer[Gsp57LocusSubdata]
    unknown_varint7: int
    substring1: Gsp57LocusSubstring1
    country: str
    def __init__(self, service_data: _Optional[_Union[Gsp57LocusServiceData, _Mapping]] = ..., country_data: _Optional[_Union[Gsp57LocusCountryData, _Mapping]] = ..., country_code: _Optional[str] = ..., subdata: _Optional[_Iterable[_Union[Gsp57LocusSubdata, _Mapping]]] = ..., unknown_varint7: _Optional[int] = ..., substring1: _Optional[_Union[Gsp57LocusSubstring1, _Mapping]] = ..., country: _Optional[str] = ...) -> None: ...

class Gsp57LocusSubdata(_message.Message):
    ...
    unknown_varint1: int
    unknown_varint3: int
    subdata6: Gsp57LocusSubdata6
    def __init__(self, unknown_varint1: _Optional[int] = ..., unknown_varint3: _Optional[int] = ..., subdata6: _Optional[_Union[Gsp57LocusSubdata6, _Mapping]] = ...) -> None: ...

class Gsp57LocusServiceData(_message.Message):
    ...
    ios_version: str
    unknown_varint7: int
    subdata1: Gsp57LocusSubdata1
    unknown_varint9: int
    unknown_varint12: int
    subdata2: Gsp57LocusSubdata2
    os: str
    unknown_double18: float
    def __init__(self, service: _Optional[str] = ..., version: _Optional[str] = ..., unknown_string3: _Optional[str] = ..., model: _Optional[str] = ..., ios_version: _Optional[str] = ..., unknown_varint7: _Optional[int] = ..., subdata1: _Optional[_Union[Gsp57LocusSubdata1, _Mapping]] = ..., unknown_varint9: _Optional[int] = ..., unknown_varint12: _Optional[int] = ..., subdata2: _Optional[_Union[Gsp57LocusSubdata2, _Mapping]] = ..., os: _Optional[str] = ..., unknown_double18: _Optional[float] = ...) -> None: ...

class Gsp57LocusCountryData(_message.Message):
    ...
    subdata3: Gsp57LocusSubdata3
    unknown_varint26: int
    unknown_string28: str
    country: str
    unknown_varint31: int
    subdata4: Gsp57LocusSubdata4
    def __init__(self, language: _Optional[str] = ..., country_code: _Optional[str] = ..., unknown_string9: _Optional[str] = ..., unknown_varint10: _Optional[int] = ..., unknown_varint11: _Optional[int] = ..., unknown_varint12: _Optional[int] = ..., unknown_varint16: _Optional[int] = ..., unknown_varint19: _Optional[int] = ..., subdata3: _Optional[_Union[Gsp57LocusSubdata3, _Mapping]] = ..., unknown_varint26: _Optional[int] = ..., unknown_string28: _Optional[str] = ..., country: _Optional[str] = ..., unknown_varint31: _Optional[int] = ..., subdata4: _Optional[_Union[Gsp57LocusSubdata4, _Mapping]] = ...) -> None: ...

class Gsp57LocusOs(_message.Message):
...
class Gsp57LocusSubdata1(_message.Message):
...
class Gsp57LocusSubdata2(_message.Message):
...
class Gsp57LocusSubdata3(_message.Message):
    __slots__ = ("unknown_varint1", "unknown_varint2")
    UNKNOWN_VARINT1_FIELD_NUMBER: _ClassVar[int]
    UNKNOWN_VARINT2_FIELD_NUMBER: _ClassVar[int]
...
class Gsp57LocusSubdata4(_message.Message):
    __slots__ = ("subdata5",)
    SUBDATA5_FIELD_NUMBER: _ClassVar[int]
    subdata5: Gsp57LocusSubdata5
    def __init__(self, subdata5: _Optional[_Union[Gsp57LocusSubdata5, _Mapping]] = ...) -> None: ...

class Gsp57LocusSubdata5(_message.Message):
    __slots__ = ("unknown_varint1", "unknown_varint2")
    UNKNOWN_VARINT1_FIELD_NUMBER: _ClassVar[int]
    UNKNOWN_VARINT2_FIELD_NUMBER: _ClassVar[int]
    unknown_varint1: int
...
class Gsp57LocusSubdata6(_message.Message):
    __slots__ = ("subdata7",)
    SUBDATA7_FIELD_NUMBER: _ClassVar[int]
    subdata7: Gsp57LocusSubdata7
    def __init__(self, subdata7: _Optional[_Union[Gsp57LocusSubdata7, _Mapping]] = ...) -> None: ...

class Gsp57LocusSubdata7(_message.Message):
    __slots__ = ("version",)
    VERSION_FIELD_NUMBER: _ClassVar[int]
    version: str
    def __init__(self, version: _Optional[str] = ...) -> None: ...

class Gsp57LocusSubstring1(_message.Message):
    __slots__ = ("substring2", "unknown_varint2")
    SUBSTRING2_FIELD_NUMBER: _ClassVar[int]
    UNKNOWN_VARINT2_FIELD_NUMBER: _ClassVar[int]
    substring2: Gsp57LocusSubstring2
    unknown_varint2: int
    def __init__(self, substring2: _Optional[_Union[Gsp57LocusSubstring2, _Mapping]] = ..., unknown_varint2: _Optional[int] = ...) -> None: ...

class Gsp57LocusSubstring2(_message.Message):
    __slots__ = ("substring3",)
    SUBSTRING3_FIELD_NUMBER: _ClassVar[int]
    substring3: Gsp57LocusSubstring3
    def __init__(self, substring3: _Optional[_Union[Gsp57LocusSubstring3, _Mapping]] = ...) -> None: ...

class Gsp57LocusSubstring3(_message.Message):
    __slots__ = ("location", "bssid_info", "timestamp_begin", "timestamp_end")
    ...
    bssid_info: _containers.RepeatedCompositeFieldContainer[Gsp57LocusBssidInfo]
    timestamp_begin: int
    timestamp_end: int
    def __init__(self, location: _Optional[_Iterable[_Union[Location, _Mapping]]] = ..., bssid_info: _Optional[_Iterable[_Union[Gsp57LocusBssidInfo, _Mapping]]] = ..., timestamp_begin: _Optional[int] = ..., timestamp_end: _Optional[int] = ...) -> None: ...

class Gsp57LocusBssidInfo(_message.Message):
...
class Location(_message.Message):
    __slots__ = ("coordinates", "timestamp", "unknown_double5")
    ...
    def __init__(self, coordinates: _Optional[_Union[Coordinates, _Mapping]] = ..., timestamp: _Optional[float] = ..., unknown_double5: _Optional[float] = ...) -> None: ...
